...
/// <summary>
/// WantConstant 绑定（@ohos.ability.wantConstant）。
/// </summary>
public static unsafe partial class WantConstant
{
    private const string ModuleName = "@ohos.ability.wantConstant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[ability.wantConstant] module loaded via napi_load_module");
