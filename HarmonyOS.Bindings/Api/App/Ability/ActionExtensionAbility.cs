...
/// <summary>
/// ActionExtensionAbility 绑定（@ohos.app.ability.ActionExtensionAbility）。
/// </summary>
public static unsafe partial class ActionExtensionAbility
{
    private const string ModuleName = "@ohos.app.ability.ActionExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.ActionExtensionAbility] module loaded via napi_load_module");
