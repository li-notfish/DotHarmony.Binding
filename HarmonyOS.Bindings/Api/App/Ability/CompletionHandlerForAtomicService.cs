...
/// <summary>
/// CompletionHandlerForAtomicService 绑定（@ohos.app.ability.CompletionHandlerForAtomicService）。
/// </summary>
public static unsafe partial class CompletionHandlerForAtomicService
{
    private const string ModuleName = "@ohos.app.ability.CompletionHandlerForAtomicService";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.CompletionHandlerForAtomicService] module loaded via napi_load_module");
    ...
    /// </summary>
    public static void OnAtomicServiceRequestSuccess(string appId)
    {
        NodeApi.CallMethodVoid(Module, _onAtomicServiceRequestSuccess, appId);
    }

    /// <summary>
    /// onAtomicServiceRequestFailure
    /// </summary>
    public static void OnAtomicServiceRequestFailure(string appId, IntPtr failureCode, string failureMessage)
    {
        NodeApi.CallMethodVoid(Module, _onAtomicServiceRequestFailure, appId, failureCode, failureMessage);
    }
