...
/// <summary>
/// ContextConstant 绑定（@ohos.app.ability.contextConstant）。
/// </summary>
public static unsafe partial class ContextConstant
{
    private const string ModuleName = "@ohos.app.ability.contextConstant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.contextConstant] module loaded via napi_load_module");
