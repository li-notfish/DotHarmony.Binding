...
/// <summary>
/// ConfigurationConstant 绑定（@ohos.app.ability.ConfigurationConstant）。
/// </summary>
public static unsafe partial class ConfigurationConstant
{
    private const string ModuleName = "@ohos.app.ability.ConfigurationConstant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.ConfigurationConstant] module loaded via napi_load_module");
