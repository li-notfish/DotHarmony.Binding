...
/// <summary>
/// Convertxml 绑定（@ohos.convertxml）。
/// </summary>
public static unsafe partial class Convertxml
{
    private const string ModuleName = "@ohos.convertxml";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[convertxml] module loaded via napi_load_module");
