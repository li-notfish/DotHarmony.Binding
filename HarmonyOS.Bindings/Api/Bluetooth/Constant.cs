...
/// <summary>
/// Constant 绑定（@ohos.bluetooth.constant）。
/// </summary>
public static unsafe partial class Constant
{
    private const string ModuleName = "@ohos.bluetooth.constant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[bluetooth.constant] module loaded via napi_load_module");
