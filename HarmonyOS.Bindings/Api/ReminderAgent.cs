...
/// <summary>
/// ReminderAgent 绑定（@ohos.reminderAgent）。
/// 所需权限：ohos.permission.PUBLISH_AGENT_REMINDER
/// </summary>
public static unsafe partial class ReminderAgent
{
    private const string ModuleName = "@ohos.reminderAgent";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[reminderAgent] module loaded via napi_load_module");
