...
/// <summary>
/// CommonEventManager 绑定（@ohos.commonEventManager）。
/// </summary>
public static unsafe partial class CommonEventManager
{
    private const string ModuleName = "@ohos.commonEventManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[commonEventManager] module loaded via napi_load_module");
    ...
    private static ReadOnlySpan<byte> _createSubscriberSync => "createSubscriberSync"u8;
    private static ReadOnlySpan<byte> _subscribe => "subscribe"u8;
    private static ReadOnlySpan<byte> _subscribeToEvent => "subscribeToEvent"u8;
    ...
    /// </summary>
    public static IntPtr CreateSubscriberSync(IntPtr subscribeInfo)
    {
        return NodeApi.CallMethod<IntPtr>(Module, _createSubscriberSync, subscribeInfo);
    }
