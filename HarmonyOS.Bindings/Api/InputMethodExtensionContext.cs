...
/// <summary>
/// InputMethodExtensionContext 绑定（@ohos.InputMethodExtensionContext）。
/// </summary>
public static unsafe partial class InputMethodExtensionContext
{
    private const string ModuleName = "@ohos.InputMethodExtensionContext";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[InputMethodExtensionContext] module loaded via napi_load_module");
    ...
    /// destroy
    /// </summary>
    public static void Destroy(IntPtr callback)
    {
        NodeApi.CallMethodVoid(Module, _destroy, callback);
    }
