...
/// <summary>
/// BluetoothCommon 绑定（@ohos.bluetooth.common）。
/// </summary>
public static unsafe partial class BluetoothCommon
{
    private const string ModuleName = "@ohos.bluetooth.common";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[bluetooth.common] module loaded via napi_load_module");
