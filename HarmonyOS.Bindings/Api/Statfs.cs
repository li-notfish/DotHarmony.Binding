...
/// <summary>
/// Statfs 绑定（@ohos.statfs）。
/// </summary>
public static unsafe partial class Statfs
{
    private const string ModuleName = "@ohos.statfs";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[statfs] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _getFreeBytes => "getFreeBytes"u8;
    private static ReadOnlySpan<byte> _getTotalBytes => "getTotalBytes"u8;

    /// <summary>
    /// getFreeBytes
    /// </summary>
    public static Task<double> GetFreeBytesAsync(string path)
    {
        return NodeApi.CallMethodAsync<double>(Module, _getFreeBytes, path);
    }

    /// <summary>
    /// getTotalBytes
    /// </summary>
    public static Task<double> GetTotalBytesAsync(string path)
    {
        return NodeApi.CallMethodAsync<double>(Module, _getTotalBytes, path);
    }
