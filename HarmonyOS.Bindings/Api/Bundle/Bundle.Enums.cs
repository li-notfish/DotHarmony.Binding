...
/// <summary>
/// BundleBundleBundleFlag 枚举
/// </summary>
public enum BundleBundleBundleFlag : long
{
    GetBundleDefault = 0,
...
/// <summary>
/// BundleBundleColorMode 枚举
/// </summary>
public enum BundleBundleColorMode
{
    [Description("-1")]
    AutoMode,
    DarkMode = 0,
...
/// <summary>
/// BundleBundleGrantStatus 枚举
/// </summary>
public enum BundleBundleGrantStatus
{
    [Description("-1")]
    PermissionDenied,
    PermissionGranted = 0
...
/// <summary>
/// BundleBundleAbilityType 枚举
/// </summary>
public enum BundleBundleAbilityType
{
    Unknown = 0,
    Page = 1,
    Service = 2,
...
/// <summary>
/// BundleBundleDisplayOrientation 枚举
/// </summary>
public enum BundleBundleDisplayOrientation
{
    Unspecified = 0,
    Landscape = 1,
    Portrait = 2,
