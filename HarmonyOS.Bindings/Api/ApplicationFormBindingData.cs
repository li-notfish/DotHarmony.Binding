...
/// <summary>
/// ApplicationFormBindingData 绑定（@ohos.application.formBindingData）。
/// </summary>
public static unsafe partial class ApplicationFormBindingData
{
    ...
    private static ReadOnlySpan<byte> _createFormBindingData => "createFormBindingData"u8;

    /// <summary>
    /// createFormBindingData
    /// </summary>
    public static IntPtr CreateFormBindingData(string? obj = null)
    {
        return NodeApi.CallMethod<IntPtr>(Module, _createFormBindingData, obj);
    }
