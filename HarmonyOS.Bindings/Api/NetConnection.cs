...
/// <summary>
/// NetConnection 绑定（@ohos.net.connection）。
...
/// </summary>
public static unsafe partial class NetConnection
{
...
/// </summary>
public sealed partial class NetConnectionObject : JsObject
{
    public NetConnectionObject(IntPtr handle) : base(handle) { }
