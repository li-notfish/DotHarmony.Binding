...
/// <summary>
/// Theme 绑定（@ohos.arkui.theme）。
/// </summary>
public static unsafe partial class Theme
{
    private const string ModuleName = "@ohos.arkui.theme";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[arkui.theme] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _setDefaultTheme => "setDefaultTheme"u8;

    /// <summary>
    /// setDefaultTheme
    /// </summary>
    public static void SetDefaultTheme(IntPtr theme)
    {
        NodeApi.CallMethodVoid(Module, _setDefaultTheme, theme);
    }
