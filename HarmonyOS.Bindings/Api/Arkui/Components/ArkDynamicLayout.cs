...
/// <summary>
/// ArkDynamicLayout 绑定（@ohos.arkui.components.ArkDynamicLayout）。
/// </summary>
public static unsafe partial class ArkDynamicLayout
{
    private const string ModuleName = "@ohos.arkui.components.ArkDynamicLayout";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[arkui.components.ArkDynamicLayout] module loaded via napi_load_module");
