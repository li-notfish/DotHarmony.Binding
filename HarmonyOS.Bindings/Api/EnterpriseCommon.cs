...
/// <summary>
/// EnterpriseCommon 绑定（@ohos.enterprise.common）。
/// </summary>
public static unsafe partial class EnterpriseCommon
{
    private const string ModuleName = "@ohos.enterprise.common";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[enterprise.common] module loaded via napi_load_module");
