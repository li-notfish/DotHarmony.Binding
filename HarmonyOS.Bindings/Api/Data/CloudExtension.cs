...
/// <summary>
/// CloudExtension 绑定（@ohos.data.cloudExtension）。
/// </summary>
public static unsafe partial class CloudExtension
{
    private const string ModuleName = "@ohos.data.cloudExtension";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[data.cloudExtension] module loaded via napi_load_module");
