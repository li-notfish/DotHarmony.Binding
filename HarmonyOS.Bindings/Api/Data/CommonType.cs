...
/// <summary>
/// CommonType 绑定（@ohos.data.commonType）。
/// </summary>
public static unsafe partial class CommonType
{
    private const string ModuleName = "@ohos.data.commonType";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[data.commonType] module loaded via napi_load_module");
