...
/// <summary>
/// DeviceInfo 绑定（@ohos.enterprise.deviceInfo）。
/// 所需权限：ohos.permission.ENTERPRISE_GET_DEVICE_INFO
/// </summary>
public static unsafe partial class DeviceInfo
{
    private const string ModuleName = "@ohos.enterprise.deviceInfo";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[enterprise.deviceInfo] module loaded via napi_load_module");
    ...
    /// getDeviceInfo
    /// </summary>
    public static string GetDeviceInfo(global::HarmonyOS.Bindings.Api.App.Ability.WantObject admin, string label)
    {
