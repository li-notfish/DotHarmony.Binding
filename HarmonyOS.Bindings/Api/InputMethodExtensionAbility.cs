...
/// <summary>
/// InputMethodExtensionAbility 绑定（@ohos.InputMethodExtensionAbility）。
/// </summary>
public static unsafe partial class InputMethodExtensionAbility
{
    private const string ModuleName = "@ohos.InputMethodExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[InputMethodExtensionAbility] module loaded via napi_load_module");
