...
/// <summary>
/// Document 绑定（@ohos.document）。
/// </summary>
public static unsafe partial class Document
{
    private const string ModuleName = "@ohos.document";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[document] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _choose => "choose"u8;
    ...
    {
        return NodeApi.CallMethodAsyncCallback<string>(Module, _choose, null);
    }
