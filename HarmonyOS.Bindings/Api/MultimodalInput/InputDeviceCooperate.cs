...
/// <summary>
/// InputDeviceCooperate 绑定（@ohos.multimodalInput.inputDeviceCooperate）。
/// </summary>
public static unsafe partial class InputDeviceCooperate
{
    private const string ModuleName = "@ohos.multimodalInput.inputDeviceCooperate";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[multimodalInput.inputDeviceCooperate] module loaded via napi_load_module");
