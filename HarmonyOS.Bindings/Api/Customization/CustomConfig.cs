...
namespace HarmonyOS.Bindings.Api.Customization;

/// <summary>
/// CustomConfig 绑定（@ohos.customization.customConfig）。
/// </summary>
public static unsafe partial class CustomConfig
{
    private const string ModuleName = "@ohos.customization.customConfig";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[customization.customConfig] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _getChannelId => "getChannelId"u8;
    ...
    {
        return NodeApi.CallMethod<string>(Module, _getChannelId);
    }
