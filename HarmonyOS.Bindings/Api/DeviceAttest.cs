...
/// <summary>
/// DeviceAttest 绑定（@ohos.deviceAttest）。
/// </summary>
public static unsafe partial class DeviceAttest
{
    private const string ModuleName = "@ohos.deviceAttest";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[deviceAttest] module loaded via napi_load_module");
