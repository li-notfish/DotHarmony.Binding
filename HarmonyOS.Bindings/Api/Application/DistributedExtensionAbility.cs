...
/// <summary>
/// DistributedExtensionAbility 绑定（@ohos.application.DistributedExtensionAbility）。
/// </summary>
public static unsafe partial class DistributedExtensionAbility
{
    private const string ModuleName = "@ohos.application.DistributedExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.DistributedExtensionAbility] module loaded via napi_load_module");
