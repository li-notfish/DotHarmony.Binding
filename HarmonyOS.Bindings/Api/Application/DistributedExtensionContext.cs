...
/// <summary>
/// DistributedExtensionContext 绑定（@ohos.application.DistributedExtensionContext）。
/// </summary>
public static unsafe partial class DistributedExtensionContext
{
    private const string ModuleName = "@ohos.application.DistributedExtensionContext";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.DistributedExtensionContext] module loaded via napi_load_module");
    ...
    /// </summary>
    public static double ConnectServiceExtensionAbility(IntPtr want, IntPtr options)
    {
        return NodeApi.CallMethod<double>(Module, _connectServiceExtensionAbility, want, options);
    }
...
public sealed partial class DistributedExtensionContextObject : JsObject
{
    ...
    /// connectServiceExtensionAbility
    /// </summary>
    public double ConnectServiceExtensionAbility(global::HarmonyOS.Bindings.Api.App.Ability.WantObject want, IntPtr options)
    {
