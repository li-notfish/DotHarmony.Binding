...
/// <summary>
/// UserAccessCtrl 绑定（@ohos.userIAM.userAccessCtrl）。
/// </summary>
public static unsafe partial class UserAccessCtrl
{
    private const string ModuleName = "@ohos.userIAM.userAccessCtrl";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[userIAM.userAccessCtrl] module loaded via napi_load_module");
