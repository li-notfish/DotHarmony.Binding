...
/// <summary>
/// PrivacyManager 绑定（@ohos.privacyManager）。
/// </summary>
public static unsafe partial class PrivacyManager
{
    private const string ModuleName = "@ohos.privacyManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[privacyManager] module loaded via napi_load_module");
