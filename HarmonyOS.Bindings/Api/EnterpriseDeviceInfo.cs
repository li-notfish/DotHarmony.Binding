...
/// <summary>
/// EnterpriseDeviceInfo 绑定（@ohos.enterprise.deviceInfo）。
/// 所需权限：ohos.permission.ENTERPRISE_GET_DEVICE_INFO
/// </summary>
public static unsafe partial class EnterpriseDeviceInfo
{
    ...
    /// getDeviceInfo
    /// </summary>
    public static string GetDeviceInfo(IntPtr admin, string label)
    {
