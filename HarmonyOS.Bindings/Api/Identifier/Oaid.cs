...
namespace HarmonyOS.Bindings.Api.Identifier;

/// <summary>
/// Oaid 绑定（@ohos.identifier.oaid）。
/// 所需权限：ohos.permission.APP_TRACKING_CONSENT
/// </summary>
public static unsafe partial class Oaid
{
    private const string ModuleName = "@ohos.identifier.oaid";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[identifier.oaid] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _getOAID => "getOAID"u8;

    /// <summary>
    /// getOAID
    /// </summary>
    public static Task<string> GetOaidAsync()
    {
        return NodeApi.CallMethodAsync<string>(Module, _getOAID);
    }
