...
// 源头文件: native_node.h, native_type.h, native_node_napi.h, common_type.h, native_animate.h, native_type_visual.h, node_attributes/*.h
#nullable enable
...
public enum ArkUI_FinishCallbackType
{
    ...
    ARKUI_FINISH_CALLBACK_LOGICALLY = 1,
}
...
public enum ArkUI_ListItemSwipeActionDirection
{
    ARKUI_LIST_ITEM_SWIPE_ACTION_DIRECTION_START = 0,
    ARKUI_LIST_ITEM_SWIPE_ACTION_DIRECTION_END = 1,
}

public enum ArkUI_ListItemSwipeActionState
{
    ARKUI_LIST_ITEM_SWIPE_ACTION_STATE_COLLAPSED = 0,
    ARKUI_LIST_ITEM_SWIPE_ACTION_STATE_EXPANDED = 1,
    ARKUI_LIST_ITEM_SWIPE_ACTION_STATE_ACTIONING = 2,
}

public enum ArkUI_ListItemSwipeEdgeEffect
{
    ARKUI_LIST_ITEM_SWIPE_EDGE_EFFECT_SPRING = 0,
    ARKUI_LIST_ITEM_SWIPE_EDGE_EFFECT_NONE = 1,
}
