...
public abstract class JsObject : IDisposable
{
    ...
    protected T CallMethod<T>(ReadOnlySpan<byte> methodName, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
    ...
    protected TCall CallMethod<TCall>(ReadOnlySpan<byte> methodName, Func<IntPtr, TCall> convert, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
    ...
    protected void CallMethodVoid(ReadOnlySpan<byte> methodName, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
    ...
    protected Task<T> CallMethodAsync<T>(ReadOnlySpan<byte> methodName, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
    ...
    protected Task<TCall> CallMethodAsync<TCall>(ReadOnlySpan<byte> methodName, Func<IntPtr, TCall> convert, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
    ...
    protected Task CallMethodAsyncVoid(ReadOnlySpan<byte> methodName, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
    ...
    /// </summary>
    protected Task<T> CallMethodAsyncCallback<T>(ReadOnlySpan<byte> methodName, Func<IntPtr, T>? convert, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
    ...
    protected Task CallMethodAsyncCallbackVoid(ReadOnlySpan<byte> methodName, params ReadOnlySpan<NapiArg> args)
    {
#if HARMONYOS
        ThrowIfDisposed();
