...
/// <summary>
/// FaceAuth 绑定（@ohos.userIAM.faceAuth）。
/// </summary>
public static unsafe partial class FaceAuth
{
    private const string ModuleName = "@ohos.userIAM.faceAuth";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[userIAM.faceAuth] module loaded via napi_load_module");
