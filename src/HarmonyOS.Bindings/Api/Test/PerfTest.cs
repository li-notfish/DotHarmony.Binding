...
namespace HarmonyOS.Bindings.Api.Test;

/// <summary>
/// PerfTest 绑定（@ohos.test.PerfTest）。
/// </summary>
public static unsafe partial class PerfTest
{
    private const string ModuleName = "@ohos.test.PerfTest";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[test.PerfTest] module loaded via napi_load_module");
    ...
    private static ReadOnlySpan<byte> _getMeasureResult => "getMeasureResult"u8;
    private static ReadOnlySpan<byte> _destroy => "destroy"u8;

    /// <summary>
    /// create
    /// </summary>
    public static IntPtr Create(IntPtr strategy)
    {
        return NodeApi.CallMethod<IntPtr>(Module, _create, strategy);
    }
    ...
    /// getMeasureResult
    /// </summary>
    public static IntPtr GetMeasureResult(IntPtr metric)
    {
        return NodeApi.CallMethod<IntPtr>(Module, _getMeasureResult, metric);
    }
    ...
    {
        NodeApi.CallMethodVoid(Module, _destroy);
    }
