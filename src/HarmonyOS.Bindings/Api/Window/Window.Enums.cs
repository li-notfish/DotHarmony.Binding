...
/// <summary>
/// WindowWindowColorSpace 枚举
/// </summary>
public enum WindowWindowColorSpace
{
    Default = 0,
    WideGamut = 1
}
...
/// <summary>
/// WindowWindowRectChangeReason 枚举
/// </summary>
public enum WindowWindowRectChangeReason
{
    Undefined = 0,
    Maximize = 1,
    Recover = 2,
...
/// <summary>
/// WindowWindowOrientation 枚举
/// </summary>
public enum WindowWindowOrientation
{
    Unspecified = 0,
    Portrait = 1,
    Landscape = 2,
...
/// <summary>
/// WindowWindowRectType 枚举
/// </summary>
public enum WindowWindowRectType
{
    RelativeToScreen = 0,
