...
/// <summary>
/// FormInfo 绑定（@ohos.app.form.formInfo）。
/// </summary>
public static unsafe partial class FormInfo
{
    private const string ModuleName = "@ohos.app.form.formInfo";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.form.formInfo] module loaded via napi_load_module");
