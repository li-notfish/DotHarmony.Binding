...
/// <summary>
/// FormEditExtensionAbility 绑定（@ohos.app.form.FormEditExtensionAbility）。
/// </summary>
public static unsafe partial class FormEditExtensionAbility
{
    private const string ModuleName = "@ohos.app.form.FormEditExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.form.FormEditExtensionAbility] module loaded via napi_load_module");
