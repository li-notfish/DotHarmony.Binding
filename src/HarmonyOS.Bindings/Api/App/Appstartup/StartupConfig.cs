...
/// <summary>
/// StartupConfig 绑定（@ohos.app.appstartup.StartupConfig）。
/// </summary>
public static unsafe partial class StartupConfig
{
    private const string ModuleName = "@ohos.app.appstartup.StartupConfig";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.appstartup.StartupConfig] module loaded via napi_load_module");
