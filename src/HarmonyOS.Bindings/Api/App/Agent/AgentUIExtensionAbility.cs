...
/// <summary>
/// AgentUIExtensionAbility 绑定（@ohos.app.agent.AgentUIExtensionAbility）。
/// </summary>
public static unsafe partial class AgentUIExtensionAbility
{
    private const string ModuleName = "@ohos.app.agent.AgentUIExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.agent.AgentUIExtensionAbility] module loaded via napi_load_module");
