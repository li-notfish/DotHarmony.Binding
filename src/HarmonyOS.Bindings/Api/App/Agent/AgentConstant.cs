...
/// <summary>
/// AgentConstant 绑定（@ohos.app.agent.agentConstant）。
/// </summary>
public static unsafe partial class AgentConstant
{
    private const string ModuleName = "@ohos.app.agent.agentConstant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.agent.agentConstant] module loaded via napi_load_module");
