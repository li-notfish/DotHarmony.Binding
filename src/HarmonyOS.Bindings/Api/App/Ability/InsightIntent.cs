...
/// <summary>
/// InsightIntent 绑定（@ohos.app.ability.insightIntent）。
/// </summary>
public static unsafe partial class InsightIntent
{
    private const string ModuleName = "@ohos.app.ability.insightIntent";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.insightIntent] module loaded via napi_load_module");
