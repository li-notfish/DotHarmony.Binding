...
/// <summary>
/// FenceExtensionAbility 绑定（@ohos.app.ability.FenceExtensionAbility）。
/// </summary>
public static unsafe partial class FenceExtensionAbility
{
    private const string ModuleName = "@ohos.app.ability.FenceExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.FenceExtensionAbility] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _onFenceStatusChange => "onFenceStatusChange"u8;
    private static ReadOnlySpan<byte> _onDestroy => "onDestroy"u8;

    /// <summary>
    /// onFenceStatusChange
    /// </summary>
    public static void OnFenceStatusChange(IntPtr transition, IntPtr additions)
    {
        NodeApi.CallMethodVoid(Module, _onFenceStatusChange, transition, additions);
    }
