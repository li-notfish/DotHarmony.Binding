...
/// <summary>
/// EmbeddedUIExtensionAbility 绑定（@ohos.app.ability.EmbeddedUIExtensionAbility）。
/// </summary>
public static unsafe partial class EmbeddedUIExtensionAbility
{
    private const string ModuleName = "@ohos.app.ability.EmbeddedUIExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.EmbeddedUIExtensionAbility] module loaded via napi_load_module");
