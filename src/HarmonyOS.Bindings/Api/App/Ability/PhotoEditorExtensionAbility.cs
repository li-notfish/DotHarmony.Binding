...
/// <summary>
/// PhotoEditorExtensionAbility 绑定（@ohos.app.ability.PhotoEditorExtensionAbility）。
/// </summary>
public static unsafe partial class PhotoEditorExtensionAbility
{
    private const string ModuleName = "@ohos.app.ability.PhotoEditorExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.PhotoEditorExtensionAbility] module loaded via napi_load_module");
    ...
    private static ReadOnlySpan<byte> _onStartContentEditing => "onStartContentEditing"u8;
    ...
    /// </summary>
    public static void OnStartContentEditing(string uri, IntPtr want, IntPtr session)
    {
        NodeApi.CallMethodVoid(Module, _onStartContentEditing, uri, want, session);
    }
