...
/// <summary>
/// InsightIntentProvider 绑定（@ohos.app.ability.insightIntentProvider）。
/// </summary>
public static unsafe partial class InsightIntentProvider
{
    private const string ModuleName = "@ohos.app.ability.insightIntentProvider";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.insightIntentProvider] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _sendExecuteResult => "sendExecuteResult"u8;
    private static ReadOnlySpan<byte> _sendIntentResult => "sendIntentResult"u8;
