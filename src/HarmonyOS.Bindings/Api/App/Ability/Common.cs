...
/// <summary>
/// Common 绑定（@ohos.app.ability.common）。
/// </summary>
public static unsafe partial class Common
{
    private const string ModuleName = "@ohos.app.ability.common";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.common] module loaded via napi_load_module");
