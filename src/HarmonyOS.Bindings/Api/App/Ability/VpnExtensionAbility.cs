...
/// <summary>
/// VpnExtensionAbility 绑定（@ohos.app.ability.VpnExtensionAbility）。
/// </summary>
public static unsafe partial class VpnExtensionAbility
{
    private const string ModuleName = "@ohos.app.ability.VpnExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.VpnExtensionAbility] module loaded via napi_load_module");
