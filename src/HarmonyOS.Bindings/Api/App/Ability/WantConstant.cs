...
/// <summary>
/// WantConstant 绑定（@ohos.app.ability.wantConstant）。
/// </summary>
public static unsafe partial class WantConstant
{
    private const string ModuleName = "@ohos.app.ability.wantConstant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.wantConstant] module loaded via napi_load_module");
