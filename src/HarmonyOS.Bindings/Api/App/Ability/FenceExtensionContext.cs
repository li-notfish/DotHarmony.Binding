...
/// <summary>
/// FenceExtensionContext 绑定（@ohos.app.ability.FenceExtensionContext）。
/// </summary>
public static unsafe partial class FenceExtensionContext
{
    private const string ModuleName = "@ohos.app.ability.FenceExtensionContext";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.FenceExtensionContext] module loaded via napi_load_module");
...
/// <summary>
/// FenceExtensionContext 实例包装（@ohos 命名空间内嵌套类）。
/// 由 JsObject 持有 napi 强引用；Dispose 仅释放引用，JS 对象由 ArkTS GC 管理。
/// </summary>
public sealed partial class FenceExtensionContextObject : JsObject
{
    public FenceExtensionContextObject(IntPtr handle) : base(handle) { }
}
