...
public sealed partial class StartOptionsObject : JsObject
{
    ...
    /// completionHandler
    /// </summary>
    public global::HarmonyOS.Bindings.Api.App.Ability.CompletionHandlerObject? CompletionHandler => GetPropertyRaw(_completionHandler) == IntPtr.Zero ? null : new global::HarmonyOS.Bindings.Api.App.Ability.CompletionHandlerObject(GetPropertyRaw(_completionHandler));
