...
/// <summary>
/// OpenLinkOptions 绑定（@ohos.app.ability.OpenLinkOptions）。
/// </summary>
public static unsafe partial class OpenLinkOptions
{
    private const string ModuleName = "@ohos.app.ability.OpenLinkOptions";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.OpenLinkOptions] module loaded via napi_load_module");
