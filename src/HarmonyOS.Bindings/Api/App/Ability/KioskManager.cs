...
/// <summary>
/// KioskManager 绑定（@ohos.app.ability.kioskManager）。
/// </summary>
public static unsafe partial class KioskManager
{
    private const string ModuleName = "@ohos.app.ability.kioskManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.kioskManager] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _enterKioskMode => "enterKioskMode"u8;
    private static ReadOnlySpan<byte> _exitKioskMode => "exitKioskMode"u8;
