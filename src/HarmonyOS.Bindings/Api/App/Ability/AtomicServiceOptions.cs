...
/// <summary>
/// AtomicServiceOptions 绑定（@ohos.app.ability.AtomicServiceOptions）。
/// </summary>
public static unsafe partial class AtomicServiceOptions
{
    private const string ModuleName = "@ohos.app.ability.AtomicServiceOptions";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.AtomicServiceOptions] module loaded via napi_load_module");
