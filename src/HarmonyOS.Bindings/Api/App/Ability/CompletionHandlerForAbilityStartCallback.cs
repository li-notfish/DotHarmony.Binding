...
/// <summary>
/// CompletionHandlerForAbilityStartCallback 绑定（@ohos.app.ability.CompletionHandlerForAbilityStartCallback）。
/// </summary>
public static unsafe partial class CompletionHandlerForAbilityStartCallback
{
    private const string ModuleName = "@ohos.app.ability.CompletionHandlerForAbilityStartCallback";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.CompletionHandlerForAbilityStartCallback] module loaded via napi_load_module");
