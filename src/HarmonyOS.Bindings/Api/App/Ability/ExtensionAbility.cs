...
/// <summary>
/// ExtensionAbility 绑定（@ohos.app.ability.ExtensionAbility）。
/// </summary>
public static unsafe partial class ExtensionAbility
{
    private const string ModuleName = "@ohos.app.ability.ExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.ExtensionAbility] module loaded via napi_load_module");
