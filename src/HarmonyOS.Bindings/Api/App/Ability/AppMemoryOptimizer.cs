...
/// <summary>
/// AppMemoryOptimizer 绑定（@ohos.app.ability.appMemoryOptimizer）。
/// </summary>
public static unsafe partial class AppMemoryOptimizer
{
    private const string ModuleName = "@ohos.app.ability.appMemoryOptimizer";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.appMemoryOptimizer] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _evictFilePages => "evictFilePages"u8;
    private static ReadOnlySpan<byte> _evictModuleFilePages => "evictModuleFilePages"u8;
