...
/// <summary>
/// SystemConfiguration 绑定（@ohos.app.ability.systemConfiguration）。
/// </summary>
public static unsafe partial class SystemConfiguration
{
    private const string ModuleName = "@ohos.app.ability.systemConfiguration";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.systemConfiguration] module loaded via napi_load_module");
