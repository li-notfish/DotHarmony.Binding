...
/// <summary>
/// ChildProcess 绑定（@ohos.app.ability.ChildProcess）。
/// </summary>
public static unsafe partial class ChildProcess
{
    private const string ModuleName = "@ohos.app.ability.ChildProcess";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.ChildProcess] module loaded via napi_load_module");
