...
/// <summary>
/// ShareExtensionAbility 绑定（@ohos.app.ability.ShareExtensionAbility）。
/// </summary>
public static unsafe partial class ShareExtensionAbility
{
    private const string ModuleName = "@ohos.app.ability.ShareExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.ShareExtensionAbility] module loaded via napi_load_module");
