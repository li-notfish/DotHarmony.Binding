...
/// <summary>
/// InsightIntentDecorator 绑定（@ohos.app.ability.InsightIntentDecorator）。
/// </summary>
public static unsafe partial class InsightIntentDecorator
{
    private const string ModuleName = "@ohos.app.ability.InsightIntentDecorator";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.InsightIntentDecorator] module loaded via napi_load_module");
