...
/// <summary>
/// CompletionHandler 绑定（@ohos.app.ability.CompletionHandler）。
/// </summary>
public static unsafe partial class CompletionHandler
{
    private const string ModuleName = "@ohos.app.ability.CompletionHandler";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.CompletionHandler] module loaded via napi_load_module");
    ...
    /// onRequestSuccess
    /// </summary>
    public static void OnRequestSuccess(IntPtr elementName, string message)
    {
        NodeApi.CallMethodVoid(Module, _onRequestSuccess, elementName, message);
    }

    /// <summary>
    /// onRequestFailure
    /// </summary>
    public static void OnRequestFailure(IntPtr elementName, string message)
    {
        NodeApi.CallMethodVoid(Module, _onRequestFailure, elementName, message);
    }
