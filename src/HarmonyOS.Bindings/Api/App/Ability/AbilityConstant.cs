...
/// <summary>
/// AbilityConstant 绑定（@ohos.app.ability.AbilityConstant）。
/// </summary>
public static unsafe partial class AbilityConstant
{
    private const string ModuleName = "@ohos.app.ability.AbilityConstant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.AbilityConstant] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _REASON_MESSAGE_DESKTOP_SHORTCUT => "REASON_MESSAGE_DESKTOP_SHORTCUT"u8;

    /// <summary>
    /// REASON_MESSAGE_DESKTOP_SHORTCUT
    /// </summary>
    public static string ReasonMessageDesktopShortcut => NativeValue.ToString(NodeApi.GetProperty(Module, _REASON_MESSAGE_DESKTOP_SHORTCUT)) ?? string.Empty;
