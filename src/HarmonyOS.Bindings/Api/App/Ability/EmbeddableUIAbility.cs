...
/// <summary>
/// EmbeddableUIAbility 绑定（@ohos.app.ability.EmbeddableUIAbility）。
/// </summary>
public static unsafe partial class EmbeddableUIAbility
{
    private const string ModuleName = "@ohos.app.ability.EmbeddableUIAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.EmbeddableUIAbility] module loaded via napi_load_module");
