...
/// <summary>
/// InsightIntentEntryExecutor 绑定（@ohos.app.ability.InsightIntentEntryExecutor）。
/// </summary>
public static unsafe partial class InsightIntentEntryExecutor
{
    private const string ModuleName = "@ohos.app.ability.InsightIntentEntryExecutor";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[app.ability.InsightIntentEntryExecutor] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _onExecute => "onExecute"u8;

    /// <summary>
    /// onExecute
    /// </summary>
    public static Task<IntPtr> OnExecuteAsync()
    {
        return NodeApi.CallMethodAsync<IntPtr>(Module, _onExecute);
    }
