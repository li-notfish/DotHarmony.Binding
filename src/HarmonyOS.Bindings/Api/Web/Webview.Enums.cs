...
/// <summary>
/// WebWebviewSecurityLevel 枚举
/// </summary>
public enum WebWebviewSecurityLevel
{
    None = 0,
    Secure = 1,
    Warning = 2,
...
/// <summary>
/// WebWebviewMediaType 枚举
/// </summary>
public enum WebWebviewMediaType
{
    Video = 0,
    Audio = 1
}
...
/// <summary>
/// WebWebviewSourceType 枚举
/// </summary>
public enum WebWebviewSourceType
{
    Url = 0,
    Mse = 1
}
