...
/// <summary>
/// GesturePoint 绑定（@ohos.accessibility.GesturePoint）。
/// </summary>
public static unsafe partial class GesturePoint
{
    private const string ModuleName = "@ohos.accessibility.GesturePoint";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[accessibility.GesturePoint] module loaded via napi_load_module");
...
/// <summary>
/// GesturePoint 实例包装（@ohos 命名空间内嵌套类）。
/// 由 JsObject 持有 napi 强引用；Dispose 仅释放引用，JS 对象由 ArkTS GC 管理。
/// </summary>
public sealed partial class GesturePointObject : JsObject
{
    public GesturePointObject(IntPtr handle) : base(handle) { }

    private static ReadOnlySpan<byte> _GesturePoint => "GesturePoint"u8;

    public GesturePointObject(double positionX, double positionY)
        : this(NodeApi.CreateInstance(GesturePoint.Module, _GesturePoint, positionX, positionY)) { }
