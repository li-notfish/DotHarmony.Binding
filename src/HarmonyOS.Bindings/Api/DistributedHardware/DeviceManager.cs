...
/// <summary>
/// DeviceManager 绑定（@ohos.distributedHardware.deviceManager）。
/// </summary>
public static unsafe partial class DeviceManager
{
    private const string ModuleName = "@ohos.distributedHardware.deviceManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[distributedHardware.deviceManager] module loaded via napi_load_module");
