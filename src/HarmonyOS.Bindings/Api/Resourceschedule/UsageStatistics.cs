...
/// <summary>
/// UsageStatistics 绑定（@ohos.resourceschedule.usageStatistics）。
/// </summary>
public static unsafe partial class UsageStatistics
{
    private const string ModuleName = "@ohos.resourceschedule.usageStatistics";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[resourceschedule.usageStatistics] module loaded via napi_load_module");
