...
/// <summary>
/// DeviceStandby 绑定（@ohos.resourceschedule.deviceStandby）。
/// </summary>
public static unsafe partial class DeviceStandby
{
    private const string ModuleName = "@ohos.resourceschedule.deviceStandby";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[resourceschedule.deviceStandby] module loaded via napi_load_module");
