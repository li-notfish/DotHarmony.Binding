...
/// <summary>
/// DataRelationalStoreAssetStatus 枚举
/// </summary>
public enum DataRelationalStoreAssetStatus
{
    AssetNormal,
    AssetInsert,
    AssetUpdate,
...
/// <summary>
/// DataRelationalStoreProgress 枚举
/// </summary>
public enum DataRelationalStoreProgress
{
    SyncBegin = 0,
    SyncInProgress = 1,
    SyncFinish = 2
...
/// <summary>
/// DataRelationalStoreSecurityLevel 枚举
/// </summary>
public enum DataRelationalStoreSecurityLevel
{
    S1 = 1,
    S2 = 2,
    S3 = 3,
...
/// <summary>
/// DataRelationalStoreSyncMode 枚举
/// </summary>
public enum DataRelationalStoreSyncMode
{
    SyncModePush = 0,
    SyncModePull = 1,
    SyncModeTimeFirst,
...
/// <summary>
/// DataRelationalStoreSubscribeType 枚举
/// </summary>
public enum DataRelationalStoreSubscribeType
{
...
/// <summary>
/// DataRelationalStoreChangeType 枚举
/// </summary>
public enum DataRelationalStoreChangeType
{
    DataChange = 0,
    AssetChange = 1
}
