...
/// <summary>
/// CloudData 绑定（@ohos.data.cloudData）。
/// </summary>
public static unsafe partial class CloudData
{
    private const string ModuleName = "@ohos.data.cloudData";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[data.cloudData] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _setCloudStrategy => "setCloudStrategy"u8;
    private static ReadOnlySpan<byte> _onAutoSyncTrigger => "onAutoSyncTrigger"u8;
    private static ReadOnlySpan<byte> _offAutoSyncTrigger => "offAutoSyncTrigger"u8;
    ...
    /// onAutoSyncTrigger
    /// </summary>
    public static void OnAutoSyncTrigger(IntPtr observer)
    {
        NodeApi.CallMethodVoid(Module, _onAutoSyncTrigger, observer);
    }
