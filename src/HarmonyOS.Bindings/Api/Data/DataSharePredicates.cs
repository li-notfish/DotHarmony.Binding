...
/// <summary>
/// DataSharePredicates 绑定（@ohos.data.dataSharePredicates）。
/// </summary>
public static unsafe partial class DataSharePredicates
{
    private const string ModuleName = "@ohos.data.dataSharePredicates";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[data.dataSharePredicates] module loaded via napi_load_module");
