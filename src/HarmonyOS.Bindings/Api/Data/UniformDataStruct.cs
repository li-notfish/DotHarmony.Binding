...
/// <summary>
/// UniformDataStruct 绑定（@ohos.data.uniformDataStruct）。
/// </summary>
public static unsafe partial class UniformDataStruct
{
    private const string ModuleName = "@ohos.data.uniformDataStruct";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[data.uniformDataStruct] module loaded via napi_load_module");
