...
/// <summary>
/// DeviceStatus 绑定（@ohos.multimodalAwareness.deviceStatus）。
/// </summary>
public static unsafe partial class DeviceStatus
{
    private const string ModuleName = "@ohos.multimodalAwareness.deviceStatus";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[multimodalAwareness.deviceStatus] module loaded via napi_load_module");
    ...
    /// </summary>
    public static void On(string type, System.Action<global::HarmonyOS.ArkUI.SteadyStandingStatus> callback)
    {
        _eventListeners.Add((type, callback),
            args => callback((global::HarmonyOS.ArkUI.SteadyStandingStatus)NativeValue.ToInt(args[0])),
    ...
    /// </summary>
    public static void Off(string type, System.Action<global::HarmonyOS.ArkUI.SteadyStandingStatus> callback)
    {
        _eventListeners.Remove((type, callback), js => NodeApi.CallMethodVoid(Module, _off, type, js));
    }

    /// <summary>
    /// 监听 steadyStandingDetect 事件（对应 on/off）
    /// </summary>
    public static event System.Action<global::HarmonyOS.ArkUI.SteadyStandingStatus> SteadyStandingDetect
    {
        add
        {
            _eventListeners.Add(("steadyStandingDetect", value),
                args => value((global::HarmonyOS.ArkUI.SteadyStandingStatus)NativeValue.ToInt(args[0])),
                js => NodeApi.CallMethodVoid(Module, _on, "steadyStandingDetect", js));
        }
        remove
        {
            _eventListeners.Remove(("steadyStandingDetect", value), js => NodeApi.CallMethodVoid(Module, _off, "steadyStandingDetect", js));
        }
    }
