...
/// <summary>
/// OnScreen 绑定（@ohos.multimodalAwareness.onScreen）。
/// </summary>
public static unsafe partial class OnScreen
{
    private const string ModuleName = "@ohos.multimodalAwareness.onScreen";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[multimodalAwareness.onScreen] module loaded via napi_load_module");
