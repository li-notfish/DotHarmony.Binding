...
/// <summary>
/// Sharing 绑定（@ohos.net.sharing）。
/// </summary>
public static unsafe partial class Sharing
{
    private const string ModuleName = "@ohos.net.sharing";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[net.sharing] module loaded via napi_load_module");
