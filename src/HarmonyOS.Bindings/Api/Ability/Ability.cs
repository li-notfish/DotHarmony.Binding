...
/// <summary>
/// Ability 绑定（@ohos.ability.ability）。
/// </summary>
public static unsafe partial class Ability
{
    private const string ModuleName = "@ohos.ability.ability";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[ability.ability] module loaded via napi_load_module");
