...
/// <summary>
/// GestureEvent 绑定（@ohos.multimodalInput.gestureEvent）。
/// </summary>
public static unsafe partial class GestureEvent
{
    private const string ModuleName = "@ohos.multimodalInput.gestureEvent";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[multimodalInput.gestureEvent] module loaded via napi_load_module");
