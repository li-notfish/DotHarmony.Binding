...
/// <summary>
/// MouseEvent 绑定（@ohos.multimodalInput.mouseEvent）。
/// </summary>
public static unsafe partial class MouseEvent
{
    private const string ModuleName = "@ohos.multimodalInput.mouseEvent";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[multimodalInput.mouseEvent] module loaded via napi_load_module");
