...
/// <summary>
/// TouchEvent 绑定（@ohos.multimodalInput.touchEvent）。
/// </summary>
public static unsafe partial class TouchEvent
{
    private const string ModuleName = "@ohos.multimodalInput.touchEvent";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[multimodalInput.touchEvent] module loaded via napi_load_module");
