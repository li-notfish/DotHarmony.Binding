...
/// <summary>
/// SelectionExtensionContext 绑定（@ohos.selectionInput.SelectionExtensionContext）。
/// </summary>
public static unsafe partial class SelectionExtensionContext
{
    private const string ModuleName = "@ohos.selectionInput.SelectionExtensionContext";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[selectionInput.SelectionExtensionContext] module loaded via napi_load_module");
