...
/// <summary>
/// UriPermissionManager 绑定（@ohos.application.uriPermissionManager）。
/// </summary>
public static unsafe partial class UriPermissionManager
{
    private const string ModuleName = "@ohos.application.uriPermissionManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.uriPermissionManager] module loaded via napi_load_module");
