...
/// <summary>
/// Configuration 绑定（@ohos.application.Configuration）。
/// </summary>
public static unsafe partial class Configuration
{
    private const string ModuleName = "@ohos.application.Configuration";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.Configuration] module loaded via napi_load_module");
