...
/// <summary>
/// Want 绑定（@ohos.application.Want）。
/// </summary>
public static unsafe partial class Want
{
    private const string ModuleName = "@ohos.application.Want";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.Want] module loaded via napi_load_module");
