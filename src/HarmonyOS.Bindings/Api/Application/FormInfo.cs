...
/// <summary>
/// FormInfo 绑定（@ohos.application.formInfo）。
/// </summary>
public static unsafe partial class FormInfo
{
    private const string ModuleName = "@ohos.application.formInfo";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.formInfo] module loaded via napi_load_module");
