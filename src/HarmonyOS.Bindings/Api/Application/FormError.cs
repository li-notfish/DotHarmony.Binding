...
/// <summary>
/// FormError 绑定（@ohos.application.formError）。
/// </summary>
public static unsafe partial class FormError
{
    private const string ModuleName = "@ohos.application.formError";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.formError] module loaded via napi_load_module");
