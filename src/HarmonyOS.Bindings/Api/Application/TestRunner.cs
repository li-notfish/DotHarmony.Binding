...
/// <summary>
/// TestRunner 绑定（@ohos.application.testRunner）。
/// </summary>
public static unsafe partial class TestRunner
{
    private const string ModuleName = "@ohos.application.testRunner";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.testRunner] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _onPrepare => "onPrepare"u8;
    private static ReadOnlySpan<byte> _onRun => "onRun"u8;
    ...
    {
        NodeApi.CallMethodVoid(Module, _onPrepare);
    }
    ...
    {
        NodeApi.CallMethodVoid(Module, _onRun);
    }
