...
/// <summary>
/// ConfigurationConstant 绑定（@ohos.application.ConfigurationConstant）。
/// </summary>
public static unsafe partial class ConfigurationConstant
{
    private const string ModuleName = "@ohos.application.ConfigurationConstant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[application.ConfigurationConstant] module loaded via napi_load_module");
