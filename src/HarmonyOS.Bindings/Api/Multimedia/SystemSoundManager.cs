...
/// <summary>
/// SystemSoundManager 绑定（@ohos.multimedia.systemSoundManager）。
/// </summary>
public static unsafe partial class SystemSoundManager
{
    private const string ModuleName = "@ohos.multimedia.systemSoundManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[multimedia.systemSoundManager] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _createSystemSoundPlayer => "createSystemSoundPlayer"u8;

    /// <summary>
    /// createSystemSoundPlayer
    /// </summary>
    public static Task<IntPtr> CreateSystemSoundPlayerAsync()
    {
        return NodeApi.CallMethodAsync<IntPtr>(Module, _createSystemSoundPlayer);
    }
