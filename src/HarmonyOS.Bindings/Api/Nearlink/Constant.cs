...
/// <summary>
/// Constant 绑定（@ohos.nearlink.constant）。
/// </summary>
public static unsafe partial class Constant
{
    private const string ModuleName = "@ohos.nearlink.constant";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[nearlink.constant] module loaded via napi_load_module");
