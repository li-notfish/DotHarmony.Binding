...
/// <summary>
/// AdsServiceExtensionAbility 绑定（@ohos.advertising.AdsServiceExtensionAbility）。
/// </summary>
public static unsafe partial class AdsServiceExtensionAbility
{
    private const string ModuleName = "@ohos.advertising.AdsServiceExtensionAbility";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[advertising.AdsServiceExtensionAbility] module loaded via napi_load_module");
