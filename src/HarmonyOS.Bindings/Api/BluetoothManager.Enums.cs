...
/// <summary>
/// BluetoothManagerScanDuty 枚举
/// </summary>
public enum BluetoothManagerScanDuty
{
    ScanModeLowPower = 0,
    ScanModeBalanced = 1,
...
/// <summary>
/// BluetoothManagerMatchMode 枚举
/// </summary>
public enum BluetoothManagerMatchMode
{
...
/// <summary>
/// BluetoothManagerProfileConnectionState 枚举
/// </summary>
public enum BluetoothManagerProfileConnectionState
{
    StateDisconnected = 0,
    StateConnecting = 1,
    StateConnected = 2,
...
/// <summary>
/// BluetoothManagerBluetoothState 枚举
/// </summary>
public enum BluetoothManagerBluetoothState
{
    StateOff = 0,
    StateTurningOn = 1,
    StateOn = 2,
...
/// <summary>
/// BluetoothManagerSppType 枚举
/// </summary>
public enum BluetoothManagerSppType
{
    SppRfcomm = 0
}

/// <summary>
/// BluetoothManagerScanMode 枚举
/// </summary>
public enum BluetoothManagerScanMode
{
    ScanModeNone = 0,
...
/// <summary>
/// BluetoothManagerBondState 枚举
/// </summary>
public enum BluetoothManagerBondState
{
    BondStateInvalid = 0,
    BondStateBonding = 1,
    BondStateBonded = 2
...
/// <summary>
/// BluetoothManagerMajorClass 枚举
/// </summary>
public enum BluetoothManagerMajorClass
{
    MajorMisc = 0,
    MajorComputer = 256,
    MajorPhone = 512,
...
/// <summary>
/// BluetoothManagerMajorMinorClass 枚举
/// </summary>
public enum BluetoothManagerMajorMinorClass
{
...
/// <summary>
/// BluetoothManagerPlayingState 枚举
/// </summary>
public enum BluetoothManagerPlayingState
{
    StateNotPlaying = 0,
    StatePlaying = 1
}
...
/// <summary>
/// BluetoothManagerProfileId 枚举
/// </summary>
public enum BluetoothManagerProfileId
{
    ProfileA2DpSource = 1,
