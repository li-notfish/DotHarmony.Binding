...
/// <summary>
/// Common2D 绑定（@ohos.graphics.common2D）。
/// </summary>
public static unsafe partial class Common2D
{
    private const string ModuleName = "@ohos.graphics.common2D";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[graphics.common2D] module loaded via napi_load_module");
