...
/// <summary>
/// HdrCapability 绑定（@ohos.graphics.hdrCapability）。
/// </summary>
public static unsafe partial class HdrCapability
{
    private const string ModuleName = "@ohos.graphics.hdrCapability";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[graphics.hdrCapability] module loaded via napi_load_module");
