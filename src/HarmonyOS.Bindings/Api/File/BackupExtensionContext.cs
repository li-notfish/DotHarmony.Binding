...
/// <summary>
/// BackupExtensionContext 绑定（@ohos.file.BackupExtensionContext）。
/// </summary>
public static unsafe partial class BackupExtensionContext
{
    private const string ModuleName = "@ohos.file.BackupExtensionContext";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[file.BackupExtensionContext] module loaded via napi_load_module");
