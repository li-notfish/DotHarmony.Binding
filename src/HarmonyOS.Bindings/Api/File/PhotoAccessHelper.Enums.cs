...
/// <summary>
/// FilePhotoAccessHelperNotifyType 枚举
/// </summary>
public enum FilePhotoAccessHelperNotifyType
{
    NotifyAdd,
    NotifyUpdate,
    NotifyRemove,
...
/// <summary>
/// FilePhotoAccessHelperResourceType 枚举
/// </summary>
public enum FilePhotoAccessHelperResourceType
{
    ImageResource = 1,
    VideoResource = 2
}
...
/// <summary>
/// FilePhotoAccessHelperOperationType 枚举
/// </summary>
public enum FilePhotoAccessHelperOperationType
{
    EqualTo = 1,
    NotEqualTo = 2,
    GreaterThan = 3,
