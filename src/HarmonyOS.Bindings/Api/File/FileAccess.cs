...
/// <summary>
/// FileAccess 绑定（@ohos.file.fileAccess）。
/// </summary>
public static unsafe partial class FileAccess
{
    private const string ModuleName = "@ohos.file.fileAccess";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[file.fileAccess] module loaded via napi_load_module");
