...
/// <summary>
/// CloudSyncManager 绑定（@ohos.file.cloudSyncManager）。
/// </summary>
public static unsafe partial class CloudSyncManager
{
    private const string ModuleName = "@ohos.file.cloudSyncManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[file.cloudSyncManager] module loaded via napi_load_module");
