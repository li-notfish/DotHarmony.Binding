...
/// <summary>
/// KeyManager 绑定（@ohos.file.keyManager）。
/// </summary>
public static unsafe partial class KeyManager
{
    private const string ModuleName = "@ohos.file.keyManager";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[file.keyManager] module loaded via napi_load_module");
