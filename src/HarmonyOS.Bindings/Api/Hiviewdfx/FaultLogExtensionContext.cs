...
/// <summary>
/// FaultLogExtensionContext 绑定（@ohos.hiviewdfx.FaultLogExtensionContext）。
/// </summary>
public static unsafe partial class FaultLogExtensionContext
{
    private const string ModuleName = "@ohos.hiviewdfx.FaultLogExtensionContext";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[hiviewdfx.FaultLogExtensionContext] module loaded via napi_load_module");
...
/// <summary>
/// FaultLogExtensionContext 实例包装（@ohos 命名空间内嵌套类）。
/// 由 JsObject 持有 napi 强引用；Dispose 仅释放引用，JS 对象由 ArkTS GC 管理。
/// </summary>
public sealed partial class FaultLogExtensionContextObject : JsObject
{
    public FaultLogExtensionContextObject(IntPtr handle) : base(handle) { }
}
