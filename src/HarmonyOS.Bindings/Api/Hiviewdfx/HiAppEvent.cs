...
namespace HarmonyOS.Bindings.Api.Hiviewdfx;

/// <summary>
/// HiAppEvent 绑定（@ohos.hiviewdfx.hiAppEvent）。
/// </summary>
public static unsafe partial class HiAppEvent
{
    ...
    /// configure
    /// </summary>
    public static void Configure(ConfigOption config)
    {
...
public sealed partial class AppEventPackageHolder : JsObject
{
    ...
    public AppEventPackageHolder(string watcherName)
        : this(NodeApi.CreateInstance(HiAppEvent.Module, _AppEventPackageHolder, watcherName)) { }
