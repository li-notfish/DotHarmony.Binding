...
/// <summary>
/// UiExtension 绑定（@ohos.arkui.uiExtension）。
/// </summary>
public static unsafe partial class UiExtension
{
    private const string ModuleName = "@ohos.arkui.uiExtension";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[arkui.uiExtension] module loaded via napi_load_module");
