...
/// <summary>
/// ComponentUtils 绑定（@ohos.arkui.componentUtils）。
/// </summary>
public static unsafe partial class ComponentUtils
{
    private const string ModuleName = "@ohos.arkui.componentUtils";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[arkui.componentUtils] module loaded via napi_load_module");
