...
/// <summary>
/// ArcScrollBar 绑定（@ohos.arkui.ArcScrollBar）。
/// </summary>
public static unsafe partial class ArcScrollBar
{
    private const string ModuleName = "@ohos.arkui.ArcScrollBar";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[arkui.ArcScrollBar] module loaded via napi_load_module");
