...
/// <summary>
/// ContainerReader 绑定（@ohos.arkui.components.ContainerReader）。
/// </summary>
public static unsafe partial class ContainerReader
{
    private const string ModuleName = "@ohos.arkui.components.ContainerReader";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[arkui.components.ContainerReader] module loaded via napi_load_module");
            return _moduleRef.Value;
        }
    }

    private static ReadOnlySpan<byte> _breakpointConfig => "breakpointConfig"u8;
