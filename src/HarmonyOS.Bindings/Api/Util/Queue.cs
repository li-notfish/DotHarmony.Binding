...
/// <summary>
/// Queue 绑定（@ohos.util.Queue）。
/// </summary>
public static unsafe partial class Queue
{
    private const string ModuleName = "@ohos.util.Queue";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[util.Queue] module loaded via napi_load_module");
