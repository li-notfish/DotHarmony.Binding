...
/// <summary>
/// WearDetection 绑定（@ohos.bluetooth.wearDetection）。
/// </summary>
public static unsafe partial class WearDetection
{
    private const string ModuleName = "@ohos.bluetooth.wearDetection";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[bluetooth.wearDetection] module loaded via napi_load_module");
