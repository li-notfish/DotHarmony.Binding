...
/// <summary>
/// Opp 绑定（@ohos.bluetooth.opp）。
/// </summary>
public static unsafe partial class Opp
{
    private const string ModuleName = "@ohos.bluetooth.opp";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[bluetooth.opp] module loaded via napi_load_module");
