...
/// <summary>
/// BaseProfile 绑定（@ohos.bluetooth.baseProfile）。
/// 所需权限：ohos.permission.ACCESS_BLUETOOTH
/// </summary>
public static unsafe partial class BaseProfile
{
    private const string ModuleName = "@ohos.bluetooth.baseProfile";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[bluetooth.baseProfile] module loaded via napi_load_module");
