...
/// <summary>
/// BluetoothBluetoothScanDuty 枚举
/// </summary>
public enum BluetoothBluetoothScanDuty
{
    ScanModeLowPower = 0,
    ScanModeBalanced = 1,
...
/// <summary>
/// BluetoothBluetoothMatchMode 枚举
/// </summary>
public enum BluetoothBluetoothMatchMode
{
...
/// <summary>
/// BluetoothBluetoothProfileConnectionState 枚举
/// </summary>
public enum BluetoothBluetoothProfileConnectionState
{
    StateDisconnected = 0,
    StateConnecting = 1,
    StateConnected = 2,
...
/// <summary>
/// BluetoothBluetoothBluetoothState 枚举
/// </summary>
public enum BluetoothBluetoothBluetoothState
{
    StateOff = 0,
    StateTurningOn = 1,
    StateOn = 2,
...
/// <summary>
/// BluetoothBluetoothScanMode 枚举
/// </summary>
public enum BluetoothBluetoothScanMode
{
    ScanModeNone = 0,
...
/// <summary>
/// BluetoothBluetoothBondState 枚举
/// </summary>
public enum BluetoothBluetoothBondState
{
    BondStateInvalid = 0,
    BondStateBonding = 1,
    BondStateBonded = 2
...
/// <summary>
/// BluetoothBluetoothMajorClass 枚举
/// </summary>
public enum BluetoothBluetoothMajorClass
{
    MajorMisc = 0,
    MajorComputer = 256,
    MajorPhone = 512,
...
/// <summary>
/// BluetoothBluetoothMajorMinorClass 枚举
/// </summary>
public enum BluetoothBluetoothMajorMinorClass
{
...
/// <summary>
/// BluetoothBluetoothPlayingState 枚举
/// </summary>
public enum BluetoothBluetoothPlayingState
{
    StateNotPlaying = 0,
    StatePlaying = 1
}
...
/// <summary>
/// BluetoothBluetoothProfileId 枚举
/// </summary>
public enum BluetoothBluetoothProfileId
{
    ProfileA2DpSource = 1,
