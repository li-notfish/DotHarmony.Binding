...
/// <summary>
/// Panel 绑定（@ohos.inputMethod.Panel）。
/// </summary>
public static unsafe partial class Panel
{
    private const string ModuleName = "@ohos.inputMethod.Panel";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[inputMethod.Panel] module loaded via napi_load_module");
