...
/// <summary>
/// ExtraConfig 绑定（@ohos.inputMethod.ExtraConfig）。
/// </summary>
public static unsafe partial class ExtraConfig
{
    private const string ModuleName = "@ohos.inputMethod.ExtraConfig";
    ...
    internal static IntPtr Module
    {
        get
        {
            ...
            HiLog.Info("HarmonyHost", $"[inputMethod.ExtraConfig] module loaded via napi_load_module");
